...
#                                  params.updateword, params.eta, params.peephole, params.outgate)
	...
	embg1 = T.max(embg1, axis =1)
        embg2 = T.max(embg2, axis =1)
        embp1 = T.max(embp1, axis =1)
        embp2 = T.max(embp2, axis =1)
	...
	cost = T.mean(cost_r)
        #cost = 1000 * cost + self.LW * lasagne.regularization.l2(r0 - self.iden[r])
