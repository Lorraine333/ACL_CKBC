...
###########################################################
    ...
    def GetVectorNew(self,in_vector):
        return self.output_evaluation(in_vector)
        ...
        try:
            for eidx in xrange(params.epochs):
                ...
                for _, train_index in kf:
                    ...
                    cost,costpg = self.train_function1(r,p3,pTuple,pTupleMask,neTuple1,neTuple1Mask,neTuple2,neTuple2Mask)
                    #print 'batch finished:', i
                    i=i+1

            #print costpg
            #cost1 = self.train_function1(g1x, g2x, p1x, g1mask, g2mask, p1mask,r)
                print 'Epoch ', (eidx+1), 'Cost ', cost, ' CostNo_regularization ', costpg
