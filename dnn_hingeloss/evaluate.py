...
def evaluate_lstm(tm,We,words,Rel,rel,relSize):
    ...
    Accurancy,tuple_words,tuple_vecs = evaluate_conceptNet(We,words,Rel,rel,tm,relSize)
    COPAresult = evaCOPA('../commonsendata/Eval/COPA/copa-dev-keywords.xml',words,We,rel,Rel,'cause',tm,relSize)
    # print 'WSC',WSC
    return COPAresult[0],tuple_words,tuple_vecs
...
def score(gv1,gv2,words,We,rel,Rel,relSize,tm):
    ...
    # print np.concatenate((gv1,v_r,gv2),axis = 1)
    # print np.concatenate((gv1,v_r,gv2),axis = 0)
